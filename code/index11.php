            ...
            <form id="form1" class="form" action="" method="post">
                ...
                <table>
                    <tr id="padding">
                        ...
                        <!-- <td><a href="index1.html" target="_blank"><div id="div3"><input type="radio" class="input button" value="Appointment" name="login"></div></a></td> -->
                        <br>
                        <a href="#" class="ref2">Book Appointment</a>
                        <a href="#" class="ref3">Preview Appointments</a>
                        <!-- <a href="#" class="ref4">Appointment</a> -->
