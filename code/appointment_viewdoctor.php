...
if (isset($_POST["submit1"])) {
    ...
    $sql5 = "SELECT  `Sl No`,  `Status` FROM `appointment`";
    ...
    while ($attnd5 = mysqli_fetch_array($result5)) {
        ...
        if ($_POST[$attnd5['Sl No']] == 'Blocked') {
            $sql6 = "UPDATE `appointment` SET `Status`='Blocked'  WHERE `Sl No` = '" . $attnd5['Sl No'] . "'";
            // $sql6 = "DELETE FROM `appointment`  WHERE `Sl No` = '" . $attnd5['Sl No'] . "'";
        ...
        if ($_POST[$attnd5['Sl No']] == 'Approv') {
            $sql7 = "UPDATE `appointment` SET `Status`='Approved'  WHERE `Sl No` = '" . $attnd5['Sl No'] . "'";
            ...
            <div id="view_table">
                ...
                <table class="doct" style="margin-left: auto; margin-right:auto;">
                    <tr>
                        ...
                        <th class="doct">Doctor</th>
                        <th class="doct">Location</th>
                        <th class="doct">Date</th>
                        <th class="doct">Time</th>
                        <th class="doct">Patient User Id</th>
                    ...
                    $dcname = $_SESSION['doctor'];
                    $sql = "SELECT * FROM appointment WHERE `Doctor` = '$dcname'";
                    $result = mysqli_query($conn, $sql);
                    $attn = mysqli_fetch_all($result, MYSQLI_ASSOC);
                    // print_r($attn);
                    // while($row = $result->fetch_assoc())
                    ...
                    <td class='doct'>" . $attnd["PatientUser"] . "</td>
